...
console.log("Esercizio 1:", nome("Dusan", "Angel"));
...
console.log("Esercizio 2:", numeriRandom);

/* ESERCIZIO 3
  Scrivi una funzione per ricavare solamente i valori PARI da un array composto da soli valori numerici (suggerimento: il metodo filter può aiutare)
*/

let arrayNumeri = [15, 22, 36, 43, 57, 68, 79, 81, 98, 100];

const numeriPari = () =>
  arrayNumeri.filter((arrayNumeri) => arrayNumeri % 2 === 0);
console.log("Esercizio 3:", numeriPari(arrayNumeri));

/* ESERCIZIO 4
  Scrivi una funzione per sommare i numeri contenuti in un array
*/

function sommaFunc(arrayNumeri) {
  let somma = 0;
...
console.log("Esercizio 4:", sommaFunc(arrayNumeri));

/* ESERCIZIO 5
  Scrivi una funzione per sommare i numeri contenuti in un array (usare REDUCE)
*/

const somma2 = arrayNumeri.reduce((accumulatore, elemento) => {
  return accumulatore + elemento;
}, 0);

console.log("Eserizio 5:", somma2);
...
function somma3(n) {
  for (let i = 0; i < arrayNumeri.length; i++) {
    arrayNumeriPiuN.push(arrayNumeri[i] + n);
  }
}
somma3(20);
console.log("Esercizio 6:", arrayNumeriPiuN);
...
let arrayStringhe = ["Mela", "Pera", "Arancia", "Kiwi", "Ananas"];
let nuovoArrayStringhe = [];

function stringaLenght(nuovoArrayStringhe) {
  for (let i = 0; i < arrayStringhe.length; i++) {
    nuovoArrayStringhe.push(arrayStringhe[i].length);
  }
  return nuovoArrayStringhe;
}

console.log("Esercizio 8:", stringaLenght(nuovoArrayStringhe));
...
function dispari(numeriDispari) {
  let dispari = 1;
  while (dispari <= 99) {
    numeriDispari.push(dispari);
    dispari += 2;
  }
  return numeriDispari;
}

console.log("Esercizio 9:", dispari(numeriDispari));
